...
export const info = {
  ...
  description:
    "I'm a full-stack software engineer from Oceanside, California. I have industry experience in software engineering with experience in full-stack development, devops, and infrastructure (IaC).",
} as const;
